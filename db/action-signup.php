...
if (!isset($_POST["username"]) or $_POST["username"]==NULL or !isset($_POST["email"]) or $_POST["email"]==NULL or !isset($_POST["name"]) or $_POST["name"]==NULL or !isset($_POST["password"]) or $_POST["password"]==NULL){
